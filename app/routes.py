...
def test(f_id = None, list_of_people = [], communities = None, c = None, most_important = None, smallest_node = None , test = None):
    if request.method == 'POST':
        ...
        if request.form['btnStart'] !=None:
            ...
            return render_template('/Test.html', f_id = friend_id, list_of_people = list,communities = number_of_communities, c = colors, most_important = most_important_node,smallest_node = find_smallest_node)
    return render_template('/home.html')
